...
export function fitScale(viewportWidth, viewportHeight, imageWidth, imageHeight) {
  return Math.min(viewportWidth / imageWidth, viewportHeight / imageHeight) * 0.94;
}
...
export function zoomAround(view, nextZoom, anchorX, anchorY, baseScale) {
